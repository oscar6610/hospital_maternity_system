    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_generate_reports', 'Puede generar reportes REM'), ('can_export_data', 'Puede exportar datos'), ('can_manage_all_deliveries', 'Puede gestionar todos los partos')],
            },
        ),
        migrations.CreateModel(
            name='PartoAnestesia',
